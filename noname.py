...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://sunnyslope.skschools.org/our_school',
		'https://sunnyslope.skschools.org/our_school/mission_and_vision',
		'https://sunnyslope.skschools.org/our_school/new_to_our_school',
		'https://sunnyslope.skschools.org/our_school/library',
		'https://sunnyslope.skschools.org/our_school/staff_directory',
		'https://sunnyslope.skschools.org/our_school/inclement_weather',
		'https://sunnyslope.skschools.org/our_school/attendance',
		'https://sunnyslope.skschools.org/our_school/rising_stars',
		'https://sunnyslope.skschools.org/our_school/school_report',
		'https://sunnyslope.skschools.org/our_school/tip_line',
		'https://sunnyslope.skschools.org/our_school/web_store',
		'https://sunnyslope.skschools.org/students',
		'https://sunnyslope.skschools.org/students/calendar',
		'https://sunnyslope.skschools.org/students/lunch_menu',
		'https://sunnyslope.skschools.org/students/student_dress_code',
		'https://sunnyslope.skschools.org/students/playground_rules',
		'https://sunnyslope.skschools.org/parents',
		'https://sunnyslope.skschools.org/parents/practice_and_enrichment_resources',
		'https://sunnyslope.skschools.org/parents/new_donation',
		'https://sunnyslope.skschools.org/parents/school_supply_lists',
		'https://sunnyslope.skschools.org/parents/skyward',
		'https://sunnyslope.skschools.org/parents/volunteer',
		'https://sunnyslope.skschools.org/parents/y_m_c_a_before_and_after_school_program',
		'https://sunnyslope.skschools.org/parents/homeless_education_assistance',
		'https://sunnyslope.skschools.org/pta',
		'https://sunnyslope.skschools.org/pta/get_involved',
		'https://sunnyslope.skschools.org/pta/officers',
		'https://sunnyslope.skschools.org/pta/p_t_s_a_district_council',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_sunnyslope'
