...
def get_content(web_page):
	...
	# try:
		...
		if web_soup.find(class='page-content').find_all('form') != []:
			form = 'form'

		if web_soup.find(class='page-content').find_all('embed') != []:
			embed = 'embed'

		if web_soup.find(class='page-content').find_all('iframe') != []:
			iframe = 'iframe'

		if web_soup.find(class='page-content').find_all(class_='calendargrid') != []:
			calendar = 'calendar'

		if web_soup.find(class='page-content').find_all(class_='staff-directory') != []:
			staff = 'staff'

		if web_soup.find(class='page-content').find_all(class_='news-info-cont') != []:
			news = 'news'
		...
		# Content
		if web_soup.find(class='page-content') != None and web_soup.find(class='page-content') != '':
			col1 = web_soup.find(class='page-content')
