...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://southcolby.skschools.org/our_school',
		'https://southcolby.skschools.org/our_school/tip_line',
		'https://southcolby.skschools.org/our_school/principal_s_corner',
		'https://southcolby.skschools.org/our_school/attendance',
		'https://southcolby.skschools.org/our_school/backpacks_for_kids',
		'https://southcolby.skschools.org/our_school/inclement_weather',
		'https://southcolby.skschools.org/our_school/library',
		'https://southcolby.skschools.org/our_school/new_to_our_school',
		'https://southcolby.skschools.org/our_school/photo_album',
		'https://southcolby.skschools.org/our_school/photo_album/bobcats_in_action_',
		'https://southcolby.skschools.org/our_school/photo_album/videos',
		'https://southcolby.skschools.org/our_school/school_newsletter',
		'https://southcolby.skschools.org/our_school/school_report',
		'https://southcolby.skschools.org/our_school/staff_directory',
		'https://southcolby.skschools.org/our_school/web_store',
		'https://southcolby.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://southcolby.skschools.org/our_school/photo_album/bobcats_in_action_',
		'https://southcolby.skschools.org/our_school/photo_album/videos',
		'https://southcolby.skschools.org/our_school/school_newsletter',
		'https://southcolby.skschools.org/our_school/school_report',
		...
		'https://southcolby.skschools.org/our_school/web_store',
		'https://southcolby.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://southcolby.skschools.org/students',
		'https://southcolby.skschools.org/students/calendar',
		'https://southcolby.skschools.org/students/lunch_menu',
		'https://southcolby.skschools.org/students/student_dress_code',
		'https://southcolby.skschools.org/students/SCDestiny',
		'https://southcolby.skschools.org/students/calendar',
		'https://southcolby.skschools.org/students/lunch_menu',
		'https://southcolby.skschools.org/students/student_dress_code',
		'https://southcolby.skschools.org/students/SCDestiny',
		'https://southcolby.skschools.org/parents',
		'https://southcolby.skschools.org/parents/make_a_donation',
		'https://southcolby.skschools.org/parents/math_support',
		'https://southcolby.skschools.org/parents/parent_resources',
		'https://southcolby.skschools.org/parents/parent_student_handbook',
		'https://southcolby.skschools.org/parents/school_supplies',
		'https://southcolby.skschools.org/parents/ptso',
		'https://southcolby.skschools.org/parents/skyward',
		'https://southcolby.skschools.org/parents/volunteer',
		'https://southcolby.skschools.org/parents/homeless_education_assistance',
		'https://southcolby.skschools.org/teachers',
		'https://southcolby.skschools.org/report_absence',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_southcolby'
