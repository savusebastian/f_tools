...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://orchardheights.skschools.org/our_school',
		'https://orchardheights.skschools.org/our_school/tip_line',
		'https://orchardheights.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://orchardheights.skschools.org/our_school/attendance_info',
		'https://orchardheights.skschools.org/our_school/important_contacts',
		'https://orchardheights.skschools.org/our_school/inclement_weather',
		'https://orchardheights.skschools.org/our_school/mission___vision',
		'https://orchardheights.skschools.org/our_school/new_to_our_school',
		'https://orchardheights.skschools.org/our_school/speech',
		'https://orchardheights.skschools.org/our_school/speech/articulation_resources',
		'https://orchardheights.skschools.org/our_school/speech/articulation_resources/orchard_heights_speech_',
		'https://orchardheights.skschools.org/our_school/speech/contact_me',
		'https://orchardheights.skschools.org/our_school/speech/apraxia_home_practice',
		'https://orchardheights.skschools.org/our_school/speech/apraxia_parent_information',
		'https://orchardheights.skschools.org/our_school/speech/language_home_practice',
		'https://orchardheights.skschools.org/our_school/speech/parent_resources',
		'https://orchardheights.skschools.org/our_school/speech/PKVideos',
		'https://orchardheights.skschools.org/our_school/speech/kaufman_words_for_home_practice',
		'https://orchardheights.skschools.org/our_school/speech/sign_language_and_requesting_sentences',
		'https://orchardheights.skschools.org/our_school/speech/p_k_motor_activities',
		'https://orchardheights.skschools.org/our_school/speech/p_k_weekly_themed_speech_and_language_activities',
		'https://orchardheights.skschools.org/our_school/principal_s_corner',
		'https://orchardheights.skschools.org/our_school/school_newsletter',
		'https://orchardheights.skschools.org/our_school/school_report',
		'https://orchardheights.skschools.org/our_school/staff_directory',
		'https://orchardheights.skschools.org/our_school/title_i___l_a_p_information_link',
		'https://orchardheights.skschools.org/our_school/speech',
		'https://orchardheights.skschools.org/our_school/speech/articulation_resources',
		'https://orchardheights.skschools.org/our_school/speech/articulation_resources/orchard_heights_speech_',
		'https://orchardheights.skschools.org/our_school/speech/contact_me',
		...
		'https://orchardheights.skschools.org/our_school/speech/p_k_motor_activities',
		'https://orchardheights.skschools.org/our_school/speech/p_k_weekly_themed_speech_and_language_activities',
		'https://orchardheights.skschools.org/students',
		'https://orchardheights.skschools.org/students/calendar',
		'https://orchardheights.skschools.org/students/library',
		'https://orchardheights.skschools.org/students/lunch_menu',
		'https://orchardheights.skschools.org/students/student_dress_code',
		'https://orchardheights.skschools.org/students/orchard_heights_student_handbook',
		'https://orchardheights.skschools.org/students/student_links',
		'https://orchardheights.skschools.org/students/student_cell_phone_policy',
		'https://orchardheights.skschools.org/students/school_supply_list',
		'https://orchardheights.skschools.org/parents1',
		'https://orchardheights.skschools.org/parents1/box_top_labels_for_education',
		'https://orchardheights.skschools.org/parents1/homeless_education_assistance',
		'https://orchardheights.skschools.org/parents1/make_a_donation',
		'https://orchardheights.skschools.org/parents1/p_t_s_o',
		'https://orchardheights.skschools.org/parents1/p_t_s_o/p_t_s_a_district_council',
		'https://orchardheights.skschools.org/parents1/skyward',
		'https://orchardheights.skschools.org/parents1/volunteer',
		'https://orchardheights.skschools.org/teachers',
		'https://orchardheights.skschools.org/teachers/mr__frazier',
		'https://orchardheights.skschools.org/teachers/mr__frazier/useful_links',
		'https://orchardheights.skschools.org/teachers/mr__frazier/contact_me',
		'https://orchardheights.skschools.org/teachers/mr__frazier/junior_library_guild',
		'https://orchardheights.skschools.org/teachers/mr__frazier/StoriesonAudible',
		'https://orchardheights.skschools.org/teachers/mr__frazier/tumblebooks',
		'https://orchardheights.skschools.org/teachers/mr__frazier/pebblego',
		'https://orchardheights.skschools.org/teachers/mr__frazier/pebblegonext',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_orchardheights'
