...
def get_content(web_page):
	...
	try:
		...
		if web_soup.find_all(class_='mainText')[1].find_all('form') != []:
			form = 'form'

		if web_soup.find_all(class_='mainText')[1].find_all('embed') != []:
			embed = 'embed'

		if web_soup.find_all(class_='mainText')[1].find_all('iframe') != []:
			iframe = 'iframe'

		if web_soup.find_all(class_='mainText')[1].find_all(class_='calendar') != []:
			calendar = 'calendar'

		if web_soup.find_all(class_='mainText')[1].find_all(class_='staff-directory') != []:
			staff = 'staff'

		if web_soup.find_all(class_='mainText')[1].find_all(class_='news') != []:
			news = 'news'
		...
		# Content
		if web_soup.find_all(class_='mainText'[1]) != None and web_soup.find_all(class_='mainText'[1]) != '':
			col1 = web_soup.find_all(class_='mainText'[1])
