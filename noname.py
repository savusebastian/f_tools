...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://olalla.skschools.org/our_school',
		'https://olalla.skschools.org/our_school/attendance',
		'https://olalla.skschools.org/our_school/inclement_weather',
		'https://olalla.skschools.org/our_school/destinylinks',
		'https://olalla.skschools.org/our_school/mission_and_vision',
		'https://olalla.skschools.org/our_school/new_to_our_school',
		'https://olalla.skschools.org/our_school/olalla_amazon_wishlist',
		'https://olalla.skschools.org/our_school/olalla_in_the_news',
		'https://olalla.skschools.org/our_school/principal_s_corner',
		'https://olalla.skschools.org/our_school/school_newsletter',
		'https://olalla.skschools.org/our_school/school_report',
		'https://olalla.skschools.org/our_school/staff_directory',
		'https://olalla.skschools.org/our_school/tip_line',
		'https://olalla.skschools.org/our_school/title_i___l_a_p_information',
		'https://olalla.skschools.org/our_school/web_store',
		'https://olalla.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://olalla.skschools.org/students',
		'https://olalla.skschools.org/students/calendar',
		'https://olalla.skschools.org/students/lunch_menu',
		'https://olalla.skschools.org/students/student_handbook',
		'https://olalla.skschools.org/students/school_supplies',
		'https://olalla.skschools.org/parents',
		'https://olalla.skschools.org/parents/homeless_education_assistance',
		'https://olalla.skschools.org/parents/make_a_donation',
		'https://olalla.skschools.org/parents/parent_resources',
		'https://olalla.skschools.org/parents/p_t_a',
		'https://olalla.skschools.org/parents/p_t_a/get_involved',
		'https://olalla.skschools.org/parents/p_t_a/officers',
		'https://olalla.skschools.org/parents/p_t_a/p_t_s_a_district_council',
		'https://olalla.skschools.org/parents/skyward',
		'https://olalla.skschools.org/parents/volunteer',
		'https://olalla.skschools.org/teachers',
		'https://olalla.skschools.org/library_links',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_olalla'
