...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://explorer.skschools.org/our_school',
		'https://explorer.skschools.org/our_school/application',
		'https://explorer.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://explorer.skschools.org/our_school/attendance',
		'https://explorer.skschools.org/our_school/backpacks_for_kids',
		'https://explorer.skschools.org/our_school/course_catalog',
		'https://explorer.skschools.org/our_school/field_trips',
		'https://explorer.skschools.org/our_school/ExplorerAcademyFacebook',
		'https://explorer.skschools.org/our_school/inclement_weather',
		'https://explorer.skschools.org/our_school/meet_the_office_staff',
		'https://explorer.skschools.org/our_school/school_report',
		'https://explorer.skschools.org/our_school/Staff%20Directory',
		'https://explorer.skschools.org/our_school/tip_line',
		'https://explorer.skschools.org/our_school/web_store',
		'https://explorer.skschools.org/parents',
		'https://explorer.skschools.org/parents/community_resources',
		'https://explorer.skschools.org/parents/make_a_donation',
		'https://explorer.skschools.org/parents/parent_resources',
		'https://explorer.skschools.org/parents/skyward_family_access',
		'https://explorer.skschools.org/parents/TitleILAP',
		'https://explorer.skschools.org/parents/volunteer',
		'https://explorer.skschools.org/parents/summer_resources',
		'https://explorer.skschools.org/parents/forms',
		'https://explorer.skschools.org/principal_s_corner',
		'https://explorer.skschools.org/students',
		'https://explorer.skschools.org/students/calendar',
		'https://explorer.skschools.org/students/career_center',
		'https://explorer.skschools.org/students/career_center/career_pathways',
		'https://explorer.skschools.org/students/career_center/scholarships',
		'https://explorer.skschools.org/students/career_center/running_start_information',
		'https://explorer.skschools.org/students/favorite_links',
		'https://explorer.skschools.org/students/forms',
		'https://explorer.skschools.org/students/HomelessEducationAssistance',
		'https://explorer.skschools.org/students/nav_101',
		'https://explorer.skschools.org/students/nav_101/senior_nav_101',
		'https://explorer.skschools.org/students/nav_101/junior_nav_101',
		'https://explorer.skschools.org/students/nav_101/sophomore_nav_101',
		'https://explorer.skschools.org/students/online_course_links',
		'https://explorer.skschools.org/students/p_e_forms',
		'https://explorer.skschools.org/students/student_dress_code',
		'https://explorer.skschools.org/students/student_handbook',
		'https://explorer.skschools.org/students/transcript_request',
		'https://explorer.skschools.org/teachers',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_explorer'
