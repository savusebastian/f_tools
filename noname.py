...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://manchester.skschools.org/our_school',
		'https://manchester.skschools.org/our_school/principal_s_corner',
		'https://manchester.skschools.org/our_school/meet_the_office_staff',
		'https://manchester.skschools.org/our_school/attendance',
		'https://manchester.skschools.org/our_school/library',
		'https://manchester.skschools.org/our_school/inclement_weather',
		'https://manchester.skschools.org/our_school/school_report',
		'https://manchester.skschools.org/our_school/staff_directory',
		'https://manchester.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://manchester.skschools.org/our_school/new_to_our_school',
		'https://manchester.skschools.org/our_school/tip_line',
		'https://manchester.skschools.org/our_school/web_store',
		'https://manchester.skschools.org/students',
		'https://manchester.skschools.org/students/calendar',
		'https://manchester.skschools.org/students/district_handbook',
		'https://manchester.skschools.org/students/lunch_menu',
		'https://manchester.skschools.org/students/school_supplies',
		'https://manchester.skschools.org/students/student_dress_code',
		'https://manchester.skschools.org/students/student_behavior_plan',
		'https://manchester.skschools.org/students/playground_expectations',
		'https://manchester.skschools.org/parents',
		'https://manchester.skschools.org/parents/homeless_education_assistance',
		'https://manchester.skschools.org/parents/make_a_donation',
		'https://manchester.skschools.org/parents/parent_resources',
		'https://manchester.skschools.org/parents/p_t_s_o',
		'https://manchester.skschools.org/parents/p_t_s_o/budget',
		'https://manchester.skschools.org/parents/p_t_s_o/flyers',
		'https://manchester.skschools.org/parents/p_t_s_o/general_meetings',
		'https://manchester.skschools.org/parents/p_t_s_o/officers',
		'https://manchester.skschools.org/parents/p_t_s_o/p_t_s_a_district_council',
		'https://manchester.skschools.org/parents/p_t_s_o/p_t_s_o_announcements',
		'https://manchester.skschools.org/parents/p_t_s_o/p_t_s_o_announcements/Jostensyearbooks',
		'https://manchester.skschools.org/parents/p_t_s_o/p_t_s_o_announcements/ScholasticBookfair',
		'https://manchester.skschools.org/parents/skyward',
		'https://manchester.skschools.org/parents/volunteer',
		'https://manchester.skschools.org/parents/y_m_c_a_before_and_after_school_program',
		'https://manchester.skschools.org/teachers',
		'https://manchester.skschools.org/links',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_manchester'
