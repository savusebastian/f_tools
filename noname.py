...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://www.lbschools.net/Departments/Personnel_Commission/class_specifications.cfm',
'https://www.lbschools.net/Departments/Personnel_Commission/classified_salary.cfm',
'https://www.lbschools.net/Departments/School_Budgets/cie_plans.cfm',
	]
