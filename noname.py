...
if __name__ == '__main__':
	start_time = time()
	all_sites = [
		'https://discovery.skschools.org/our_school',
		'https://discovery.skschools.org/our_school/application',
		'https://discovery.skschools.org/our_school/a_s_b_fund_balance_link',
		'https://discovery.skschools.org/our_school/attendance',
		'https://discovery.skschools.org/our_school/discovery_early_head_start',
		'https://discovery.skschools.org/our_school/inclement_weather',
		'https://discovery.skschools.org/our_school/mission_and_vision',
		'https://discovery.skschools.org/our_school/staff_directory',
		'https://discovery.skschools.org/our_school/tip_line',
		'https://discovery.skschools.org/our_school/web_store',
		'https://discovery.skschools.org/our_school/school_report',
		'https://discovery.skschools.org/principal_s_corner',
		'https://discovery.skschools.org/students',
		'https://discovery.skschools.org/students/transcript_requests',
		'https://discovery.skschools.org/students/family_access___skyward_',
		'https://discovery.skschools.org/students/school_supply_list',
		'https://discovery.skschools.org/students/student_handbook',
		'https://discovery.skschools.org/students/on-_line_class_link',
		'https://discovery.skschools.org/students/on-_line_class_link/on-_line_class_link',
		'https://discovery.skschools.org/students/graduation_memories',
		'https://discovery.skschools.org/students/graduation_memories/2020_graduation_video',
		'https://discovery.skschools.org/students/homeless_education_assistance',
		'https://discovery.skschools.org/parents',
		'https://discovery.skschools.org/parents/make_a_donation',
		'https://discovery.skschools.org/parents/parent_resources',
		'https://discovery.skschools.org/parents/p_t_s_a_district_council',
		'https://discovery.skschools.org/parents/volunteer',
		'https://discovery.skschools.org/parents/skyward_family_access',
		'https://discovery.skschools.org/teachers',
	]
	...
	with open(f'../f_web_interface/static/files/{mainfolder}/report.csv', 'w', encoding='utf-8') as csv_report:
		...
		all_links = []
		school_name = 'south_kitsap_discovery'
