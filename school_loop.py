...
def get_content(web_page):
	...
	try:
		...
		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all('form') != []:
			form = 'form'

		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all('embed') != []:
			embed = 'embed'

		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all('iframe') != []:
			iframe = 'iframe'

		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all(id='divCalendar') != []:
			calendar = 'calendar'

		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all(class_='staff-directory') != []:
			staff = 'staff'

		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container').find_all(id='news') != []:
			news = 'news'
		...
		# Content
		if web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container') != None and web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container') != '':
			col1 = web_soup.find(class_='sl-cms2-column-container__interior-mobile-layout-container')
...
if __name__ == '__main__':
	start_time = time()
	district = 'https://www.stephens.k12.ga.us'
	all_sites = [
		f'{district}',
		f'https://biga.stephens.k12.ga.us',
		f'https://liberty.stephens.k12.ga.us',
		f'https://toccoa.stephens.k12.ga.us',
		f'https://sfga-stephenscountyschools-ga.schoolloop.com',
		f'https://scms.stephens.k12.ga.us',
		f'https://schs.stephens.k12.ga.us',
	]
